                ...
                m(
                    ...
                    [
                        ...
                        m(
                            ...
                            {
                                class:
                                    Flebotomista.showConfigToma == undefined ||
                                    ...
                                    m("div.tx-30", [
                                        m("div.custom-control.custom-radio", [
                                            m(
                                                ...
                                                {
                                                    checked:
                                                        Flebotomista.idToma == "TOMA1" ? true : false,
                                                    onchange: (event) => {
                                        ...
                                        m("div.custom-control.custom-radio", [
                                            m(
                                                ...
                                                {
                                                    checked:
                                                        Flebotomista.idToma == "TOMA2" ? true : false,
                                                    onchange: (event) => {
                                                        if (Flebotomista.isConnect) {
                                                            Flebotomista.peer.peer.destroy();
                                                            Flebotomista.isConnect = !Flebotomista.isConnect;
                                        ...
                                        m("div.custom-control.custom-radio", [
                                            m(
                                                ...
                                                {
                                                    checked:
                                                        Flebotomista.idToma == "TOMA3" ? true : false,
                                                    onchange: (event) => {
                                                        if (Flebotomista.isConnect) {
                                                            Flebotomista.peer.peer.destroy();
                                                            Flebotomista.isConnect = !Flebotomista.isConnect;
                                        ...
                                        m("div.custom-control.custom-radio", [
                                            m(
                                                ...
                                                {
                                                    checked:
                                                        Flebotomista.idToma == "TOMA4" ? true : false,
                                                    onchange: (event) => {
                                                        if (Flebotomista.isConnect) {
                                                            Flebotomista.peer.peer.destroy();
                                                            Flebotomista.isConnect = !Flebotomista.isConnect;
                                        ...
                                        m("div.custom-control.custom-radio", [
                                            m(
                                                ...
                                                {
                                                    checked:
                                                        Flebotomista.idToma == "TOMA5" ? true : false,
                                                    onchange: (event) => {
                                                        if (Flebotomista.isConnect) {
                                                            Flebotomista.peer.peer.destroy();
                                                            Flebotomista.isConnect = !Flebotomista.isConnect;
                                ...
                                m(
                                    ...
                                    [
                                        m("div", { class: "media  wd-100p" }, [
                                            ...
                                            m("div", { class: "media-body mg-l-15" }, [
                                                m(
                                                    "button.btn.btn-brand-02.btn-block.tx-semibold.mg-t-1", {
...
class Flebotomista extends App {
    ...
    static autorizar() {
        this.autorizarMSA('Flebotomista');
    }
