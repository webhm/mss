                                    ...
                                    m("div.d-flex", [
                                        m("span.badge.bg-litecoin.tx-white.tx-semibold.pd-l-10.pd-r-10.mg-l-5.tx-14[role='button']", [
                                            m("div.dropdown.dropleft", [
                                                ...
                                                m("div.lh-0.mg-l-5[id='dropdownMenuButton'][data-toggle='dropdown'][aria-haspopup='true'][aria-expanded='false']", {
                                                    style: { "cursor": "pointer" },
                                                    title: "Filtrar"
                                                },

                                                    m("i.fas.fa-filter.pd-2"),
                                                    " Filtrar ",


                                                ),
                                                m(".dropdown-menu.tx-14[aria-labelledby='dropdownMenuButton']", [
                                                    m(".dropdown-header.tx-uppercase.tx-12.tx-bold.tx-inverse",
                                                        "FILTROS:"
                                                    ),
                                                    m(m.route.Link, {
                                                        class: 'dropdown-item',
